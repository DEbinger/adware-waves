...
adPostion1Container.innerHTML = `<img src="public/${pending[1].path}"><img>`;
...
adPostion2Container.innerHTML = `<img src="public/${pending[2].path}"><img>`;
...
adPostion3Container.innerHTML = `<img src="public/${pending[3].path}"><img>`;
